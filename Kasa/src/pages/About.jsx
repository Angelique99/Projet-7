...
function About() {
  return (
    <div className="about">
      <Banner image={aboutImg} overlay={false}/>

      <div className="about-content">
        <Collapse title="Fiabilité" content="Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes au logements, et toutes les informations sont régulièerement vérifiées par nos équipes."/>
